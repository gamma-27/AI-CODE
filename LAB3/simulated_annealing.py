...
class SimAnneal:
    ...
    def accept(self, candidate):
        ...
        if candidate_cost < self.best_cost:
            ...
            # Probability of accepting if candidate is worse than current.
            # Probability = 𝑒^(-𝛥𝐸/T)
...
def main():
    nodes, place = tsp_read("Data/xyz.tsp")
    sa = SimAnneal(coordinates=nodes, place=place, stopping_iter=len(nodes)*10000000)
